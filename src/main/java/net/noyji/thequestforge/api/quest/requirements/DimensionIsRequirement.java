...
public class DimensionIsRequirement extends AbstractRequirement {
    //thequestforge:dimension_is:twilightforest:twilight_fores
    @Override
    ...
    public ResourceLocation getLocation() {
        return TheQuestForge.id("dimension_is");
    }
}
