...
public class EntityTagIsNotRequirement extends AbstractRequirement {
    //thequestforge:entity_tag_is_not:minecraft:zombies
    @Override
    ...
    public ResourceLocation getLocation() {
        return TheQuestForge.id("entity_tag_is_not");
    }
}
