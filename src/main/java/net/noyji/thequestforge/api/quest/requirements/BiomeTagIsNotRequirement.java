...
public class BiomeTagIsNotRequirement extends AbstractRequirement{
    //thequestforge:biome_tag_is_not:minecraft:is_desert
    @Override
    ...
    public ResourceLocation getLocation() {
        return TheQuestForge.id("biome_tag_is_not");
    }
}
